...
type LogOffMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Id          int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Vectorclock int64 `protobuf:"varint,2,opt,name=vectorclock,proto3" json:"vectorclock,omitempty"`
}

func (x *LogOffMessage) Reset() {
	*x = LogOffMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *LogOffMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LogOffMessage) ProtoMessage() {}

func (x *LogOffMessage) ProtoReflect() protoreflect.Message {
	mi := &file_grpc_proto_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LogOffMessage.ProtoReflect.Descriptor instead.
func (*LogOffMessage) Descriptor() ([]byte, []int) {
	return file_grpc_proto_proto_rawDescGZIP(), []int{4}
}

func (x *LogOffMessage) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *LogOffMessage) GetVectorclock() int64 {
	if x != nil {
		return x.Vectorclock
	}
	return 0
...
var file_grpc_proto_proto_rawDesc = []byte{
	...
	,
...
var file_grpc_proto_proto_goTypes = []interface{}{
	...
	(*LogOffMessage)(nil),  // 4: simpleguide.logOffMessage
}
var file_grpc_proto_proto_depIdxs = []int32{
	...
	4, // 2: simpleguide.registerClient.logOffServer:input_type -> simpleguide.logOffMessage
	1, // 3: simpleguide.registerClient.registerToServer:output_type -> simpleguide.responsMessage
	3, // 4: simpleguide.registerClient.populateChatMessage:output_type -> simpleguide.errorMessage
	3, // 5: simpleguide.registerClient.logOffServer:output_type -> simpleguide.errorMessage
