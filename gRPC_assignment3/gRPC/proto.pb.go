...
func (x *MessageFromClient) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *MessageFromClient) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
func (x *MessageFromClient) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
func (x *MessageFromServer) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *MessageFromServer) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
func (x *MessageFromServer) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
var file_grpc_proto_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x0a, 0x63, 0x68, 0x69, 0x74, 0x74, 0x79, 0x43, 0x68, 0x61, 0x74, 0x22, 0x57,
	0x0a, 0x11, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x46, 0x72, 0x6f, 0x6d, 0x43, 0x6c, 0x69,
	...
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x57, 0x0a, 0x11, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x46, 0x72, 0x6f, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04,
	...
	0x32, 0x53, 0x0a, 0x04, 0x43, 0x68, 0x61, 0x74, 0x12, 0x4b, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x1d, 0x2e, 0x63, 0x68, 0x69, 0x74, 0x74, 0x79,
	0x43, 0x68, 0x61, 0x74, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x46, 0x72, 0x6f, 0x6d,
	0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x1a, 0x1d, 0x2e, 0x63, 0x68, 0x69, 0x74, 0x74, 0x79, 0x43,
	0x68, 0x61, 0x74, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x46, 0x72, 0x6f, 0x6d, 0x53,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x42, 0x0c, 0x5a, 0x0a, 0x67, 0x52, 0x50, 0x43, 0x2f, 0x70, 0x72,
...
var file_grpc_proto_proto_goTypes = []interface{}{
	(*MessageFromClient)(nil), // 0: chittyChat.MessageFromClient
	(*MessageFromServer)(nil), // 1: chittyChat.MessageFromServer
}
var file_grpc_proto_proto_depIdxs = []int32{
	0, // 0: chittyChat.Chat.ChatService:input_type -> chittyChat.MessageFromClient
	1, // 1: chittyChat.Chat.ChatService:output_type -> chittyChat.MessageFromServer
...
func file_grpc_proto_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_grpc_proto_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MessageFromServer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
